...
namespace GameOfLifeVisitor
{
    public class GameOfLifeGame
    {
        ...
        public Cell[,] Board { private set; get; }
        ...
        public void Run()
        {
            ...
            var lifeGame = new GameOfLifeGame(Board);
        ...
        private void Start()
        {
            ...
            while (true)
            {
                var cellList = UpdateBoard(Board);
                Display(Board);
        ...
        {
            var lifeVisitor = new LifeVisitor();
            var lifeCommandList = new List<LifeCommand>();
            for (var i = 0; i <= 11; i++)
            {
                for (var j = 0; j <= 11; j++)
                {
                    lifeVisitor.Visit(board[i, j], this, lifeCommandList);
                }
            }
